  ...
  return (
    <div className=" bg-[#DFBFA8] h-[450px] rounded-sm pt-24 mt-14">
      <div className="w-[434px] h-[213px]  text-center m-auto  flex flex-col justify-center items-center">
        ...
        <p className=" text-[#000000] text-left leading-normal mt-10 p-6 text-2xl w-[800px]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis velit
          reprehenderit reiciendis consequatur asperiores, doloribus rem! Vel
          asperiores dolorum eius ea eum nostrum omnis, officiis architecto
          perspiciatis? Vel, debitis ex!
        </p>
